...
import NekoXRobot.modules.sql.connection_sql as sql
from NekoXRobot import dispatcher, DRAGONS, DEV_USERS
from NekoXRobot.modules.helper_funcs import chat_status
